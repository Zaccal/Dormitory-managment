...
import { useRequestRegister } from '@/hooks/auth/useAuth'
import { RegisterForm as IRegisterForm } from '@/types/forms.types'
import { SubmitHandler, useForm } from 'react-hook-form'
import Loader from '../Loader'

const RegisterForm = () => {
    const {
        mutate: sendRequestRegister,
        isPending,
        isSuccess,
    } = useRequestRegister()
    const {
    ...
    const submitHandler: SubmitHandler<IRegisterForm> = (data, event) => {
    ...
    // TODO: Move the inputs to a new file
        ...
        >
            <div className="grid grid-cols-2 gap-y-6 gap-x-4">
                ...
                <InputWithLabel
                    label={
                        errors.patronymic
                            ? (errors.patronymic.message as string)
                            : 'Отчество'
                    }
