...
import { getAccountCreationMessage } from '@/lib/getAccountCreationMessage'
...
import SheetUserApplicationInputs, {
    ISheetForm,
} from './SheetUserApplicationInputs'
        ...
        <Sheet open={isOpen} onOpenChange={setIsOpen}>
            ...
            <SheetContent className="">
                <SheetHeader>
                    ...
                    <SheetDescription>
                        Просмотрите и обработайте заявку на проживание в
                        общежитии.
                    </SheetDescription>
                </SheetHeader>
                <form
