import useGetRecentPaymentStudents from '@/hooks/payments/useGetRecentPaymentStudents'
import RecentPaidUser from './RecentPaidUser'
import { Skeleton } from '@/components/ui/skeleton'
import useGetCountStudentPaymentMonth from '@/hooks/payments/useGetCountStudentPaymentMonth'
            ...
            <div className="flex flex-col gap-6">
                ...
                {isError && (
                    <div className="w-full h-11 bg-destructive rounded-lg text-white flex items-center px-4">
                        Ошипка:{' '}
                        {error ? error.message : 'Упс... что-то пошло не так'}
                    </div>
                )}
