import { IFormUpdateUser } from '@/hooks/user/useUpdateUser'
import { Database } from '@/types/supabase.types'
import { EnumRoleConverter, EnumStatusConverter } from '@/lib/enumToLabel'
...
const statusOptions: IOptions<
    Database['public']['Enums']['Status of student']
>[] = [
            ...
            <Controller
                ...
                render={({ field: { onChange, ref, value } }) => (
                    <Select
                        options={roleOptions}
                        ref={ref}
                        placeholder={EnumRoleConverter(value)}
            ...
            <Controller
                ...
                render={({ field: { value, ref, onChange } }) => (
                    <Select
                        ...
                        ref={ref}
                        placeholder={EnumStatusConverter(value)}
